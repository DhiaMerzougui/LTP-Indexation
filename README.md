...
Methodology: 
    ...
    1-PreProcessing chain to ensure robustness against lighting changes.(Gamma Correction, DoG, Masking, Contrast Equalization.... You know ,the usual stuff)
    2-Feature Extraction using LTP(cus LBP is kinda stupid)
    3-Matching & Classification using KNN
